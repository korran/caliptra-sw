...
use crate::{FtdiCtx, UsbPortPath, ftdi};
...
impl clap::ValueEnum for SdMuxTarget {
    ...
    fn to_possible_value<'a>(&self) -> Option<clap::PossibleValue<'a>> {
        match self {
            ...
            Self::Dut => Some(PossibleValue::new("dut").help("device-under-test can boot from sd card")),
        }
    }
}
...
impl SdMux {
    pub fn open(port_path: UsbPortPath) -> anyhow::Result<Self> {
        ...
        result.ftdi.set_interface(ftdi_interface::INTERFACE_A)?;
