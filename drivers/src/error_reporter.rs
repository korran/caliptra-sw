...
pub fn report_fw_error_non_fatal(val: u32) {
    ...
    soc_ifc.regs().cptra_fw_error_non_fatal().write(|_| val);
}
...
pub fn report_fw_error_fatal(val: u32) {
    let mut soc_ifc = unsafe { SocIfcReg::new() };
    soc_ifc.regs().cptra_fw_error_fatal().write(|_| val);
}
...
pub fn report_hw_error_non_fatal(val: u32) {
    let mut soc_ifc = unsafe { SocIfcReg::new() };
    soc_ifc.regs().cptra_hw_error_non_fatal().write(|_| val);
}
...
pub fn report_hw_error_fatal(val: u32) {
    let mut soc_ifc = unsafe { SocIfcReg::new() };
    soc_ifc.regs().cptra_hw_error_fatal().write(|_| val);
}
