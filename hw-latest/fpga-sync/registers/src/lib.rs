...
pub mod regs {
    ...
    impl ClockControlReadVal {
        ...
        ///
        #[inline(always)]
        pub fn bkpt_generic_output_wires(&self) -> bool {
            ((self.0 >> 33) & 1) != 0
        }
        ///
        #[inline(always)]
        pub fn bkpt_mailbox_data_avail(&self) -> bool {
            ((self.0 >> 34) & 1) != 0
        }
        ///
        #[inline(always)]
        pub fn bkpt_mailbox_flow_done(&self) -> bool {
            ((self.0 >> 35) & 1) != 0
        }
        ///
        #[inline(always)]
        pub fn bkpt_etrng_req(&self) -> bool {
            ((self.0 >> 36) & 1) != 0
        }
        /// Construct a WriteVal that can be used to modify the contents of this register value.
        #[inline(always)]
    ...
    impl ClockControlWriteVal {
        ...
        ///
        #[inline(always)]
        pub fn bkpt_generic_output_wires(self, val: bool) -> Self {
            Self((self.0 & !(1 << 33)) | (u64::from(val) << 33))
        }
        ///
        #[inline(always)]
        pub fn bkpt_mailbox_data_avail(self, val: bool) -> Self {
            Self((self.0 & !(1 << 34)) | (u64::from(val) << 34))
        }
        ///
        #[inline(always)]
        pub fn bkpt_mailbox_flow_done(self, val: bool) -> Self {
            Self((self.0 & !(1 << 35)) | (u64::from(val) << 35))
        }
        ///
        #[inline(always)]
        pub fn bkpt_etrng_req(self, val: bool) -> Self {
            Self((self.0 & !(1 << 36)) | (u64::from(val) << 36))
        }
    }
